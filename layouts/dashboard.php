...
<head>
	...
	<link rel="shortcut icon" href="<?php echo AST; ?>/img/ikon.png" type="image/x-icon">
...
<body>
	...
	<aside>
		...
		<header>
			<img src="<?php echo AST; ?>/img/admin.png" class="brand">
	...
	<main>
		...
		<footer>
			Copyright &copy; 2022 - <?php echo date('Y'); ?>. Designed by Anggy Permataa
		</footer>
	</main>
